...
{
    public class SetAppointmentCommandHandler : IRequestHandler<SetAppointmentCommand, BaseResponse>
    {
        private readonly IAppointmentRepository _repAppointment;
        private readonly IMapper _mapper;
        private readonly IValidator<CreateAppointmentDto> _Validator;
        public SetAppointmentCommandHandler(IMapper mapper,
        ...
        public async Task<BaseResponse> Handle(SetAppointmentCommand request, CancellationToken cancellationToken)
        {
            ...
            Appointment.StartTime = request.StartDateTime;
            Appointment.EndTime = request.StartDateTime.AddMinutes(request.DurationonMinutes);
